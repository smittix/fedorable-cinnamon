...
WIDTH=90
CHOICE_HEIGHT=4
BACKTITLE="Fedorable a Fedora-Cinnamon Post Install Setup Util - By Smittix - https://lsass.co.uk"
...
while [ "$CHOICE -ne 4" ]; do
    ...
    case $CHOICE in
	    ...
	    sudo dnf copr enable peterwu/iosevka -y
            sudo dnf update -y
     	    sudo dnf install -y iosevka-term-fonts jetbrains-mono-fonts-all terminus-fonts terminus-fonts-console google-noto-fonts-common fira-code-fonts
